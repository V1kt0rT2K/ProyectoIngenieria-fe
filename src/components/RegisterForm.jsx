    ...
    return (
        <>
            <form ref={formRef} onSubmit={register} >
                ...
                <div className="overflow-y-auto bg-gray-200 rounded h-96">
                    <div className="flex flex-col justify-center my-4 px-4">
                        <label className="mb-2 text-lg font-semibold">Nombre</label>
                        <input className="focus:outline-none mb-6 px-2 py-1 border-solid border-1 border-gray-400 rounded-md" placeholder="Nombre" name="name" type="text" />

                        <label className="mb-2 text-lg font-semibold">Apellido</label>
                        <input className="focus:outline-none  mb-6 px-2 py-1 border-solid border-1 border-gray-400 rounded-md" placeholder="Apellido" name="last_name" type="text" />
                        ...
                        <input className="focus:outline-none  mb-6 px-2 py-1 border-1 border-gray-400 rounded-md" placeholder="Contraseña" name="pass" type="password" />

                        <label className="mb-2 text-lg font-semibold">Rol de usuario</label>
                        <select className="focus:outline-none bg-white mb-6 px-2 py-1 border-1 border-gray-400 rounded-md" name="role">
