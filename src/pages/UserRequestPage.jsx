    ...
    return (
        <>
            <div style={{ height: "80vh", width: "75vw" }} className="flex flex-col pt-8">
                ...
                <p className="text-lg text-orange-800 font-semibold underline">Informacion de la solicitud</p>
                <div className="ml-2 flex flex-col mt-2 justify-center">
                    <label className="text-md text-orange-900">Nombre completo</label>
                    <input readOnly value={ fullName } className="focus:outline-none flex-grow border-1 border-solid border-orange-700 rounded py-1 px-3 text-md" />

                    <label className="mt-2 text-md text-orange-900">Numero de identidad</label>
                    <input readOnly value={ idNumber } className="focus:outline-none flex-grow border-1 border-solid border-orange-700 rounded py-1 px-3 text-md" />

                    <label className="mt-2 text-md text-orange-900">Rol de usuario</label>
                    <input readOnly value={ role } className="focus:outline-none flex-grow border-1 border-solid border-orange-700 rounded py-1 px-3 text-md" />

                    <label className="mt-2 text-md text-orange-900">Fecha de creacion de solicitud</label>
                    <input readOnly value={ date } className="focus:outline-none flex-grow border-1 border-solid border-orange-700 rounded py-1 px-3 text-md" />

                    <label className="mt-2 text-md text-orange-900">Email</label>
                    <input readOnly value={ email } className="focus:outline-none flex-grow border-1 border-solid border-orange-700 rounded py-1 px-3 text-md" />
