...
const ProviderOptions = ({ id }) => {
    return (
        <DropDown links={[
            ...
            <Link className="flex justify-center block px-4 py-2 font-semibold text-md text-white bg-orange-800 hover:cursor-pointer hover:bg-orange-900" to="/purchases/new_purchase_order" state={{ preSelectedProvider: id }}>Hacer Pedido</Link>,
