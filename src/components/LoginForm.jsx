        ...
        <>
            <form ref={ formRef } onSubmit={ login }>
                ...
                <div className="flex flex-col justify-center">
                    ...
                    <input name="email" className="mb-6 px-2 py-1 border-solid border-1 border-gray-400 rounded-md" placeholder="Email" type="email" />
                ...
                <div className="flex flex-col items-center">
                    ...
                    <input className="hover:cursor-pointer bg-orange-800 text-lg font-extrabold text-white py-1 px-3 rounded-lg shadow-lg" value="Inciar sesion" type="submit" />
                </div>
            </form>
        </>
    );
