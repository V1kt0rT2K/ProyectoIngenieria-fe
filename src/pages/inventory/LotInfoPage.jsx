                ...
                <div className="bg-orange-200 rounded overflow-y-auto p-4 border border-orange-700">
                    <div className="flex space-x-5 justify-between">
                        ...
                        <div className="flex flex-col flex-grow space-y-4">
                            <div className="flex flex-col bg-orange-100 text-md text-orange-800 font-bold px-4 py-2 space-y-2 rounded">
                                <p>Estado</p>
                                <select className="bg-orange-200 px-3 py-2 rounded hover:cursor-pointer">
                            ...
                            <div className="flex flex-col bg-orange-100 text-md text-orange-800 px-4 py-2 space-y-2 rounded">
                                ...
                                <textarea style={{ resize: "none", height: "4em" }} className="h-12 rounded bg-orange-200 px-3 py-1 focus:outline-none"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center">
                        <button className="bg-orange-700 rounded px-3 py-1 font-semibold text-white mt-2">+ Añadir animal</button>
                    </div>
                </div>
            </div>
        </>
