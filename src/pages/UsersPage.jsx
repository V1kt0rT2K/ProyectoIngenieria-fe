        ...
        <>
            <div style={{ height: "80vh" }} className="flex flex-col pt-8">
                <div className="flex flex-col items-start">
                    <button className="text-white rounded-md bg-orange-700 px-3 py-1 text-md font-semibold mb-6 hover:cursor-pointer">Solicitudes de crear usuario (12)</button>
                ...
                <div className="my-6 overflow-y-scroll border-1 border-solid border-orange-700">
                    <table className="table-fixed justify-self-center">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            {
                                ...
                                .map(user =>
                                    <tr>
                                        ...
                                        <td className="border-solid border-1 border-orange-900 bg-orange-200 py-4 px-5 justify-center"><button className="text-white rounded-md bg-orange-800 px-3 py-1 text-md font-semibold">Actividad</button></td>
                                        <td className="border-solid border-1 border-orange-900 bg-orange-200 py-4 px-5 justify-center"><button className="text-white rounded-md bg-orange-800 px-3 py-1 text-md font-semibold">Actividad</button></td>
                                    </tr>
                                )
                            }
