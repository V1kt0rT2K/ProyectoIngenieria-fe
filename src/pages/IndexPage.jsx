            ...
            <div className={`bg-gray-200 h-screen ${ showModal ? "blur-xs" : ""}`}>
                ...
                <div className="flex">
                    <div className="mx-24">
                        ...
                        <button onClick={() => setShowModal(<LoginForm />)} className="hover:cursor-pointer mr-6 text-xl my-12 bg-orange-800 rounded-md py-2 px-3 font-extrabold text-white">Iniciar sesion</button>
                        <button onClick={() => setShowModal(<RegisterForm />)} className="hover:cursor-pointer text-xl my-12 bg-orange-800 rounded-md py-2 px-3 font-extrabold text-white">Registrarse</button>
                    </div>
